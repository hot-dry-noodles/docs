...
(function() {
    ...
    var s = e.helpers = {},
        ...
        x = s.radians = function(t) { return t * (Math.PI / 180) },
        ...
        b = (s.generateLabels = function(t, i, e, s) { var o = new Array(i); return labelTemplateString && n(o, function(i, n) { o[n] = C(t, { value: e + s * (n + 1) }) }), o }, s.easingEffects = {
            ...
            easeInBounce: function(t) { return 1 - b.easeOutBounce(1 - t) },
            ...
            easeInOutBounce: function(t) { return .5 > t ? .5 * b.easeInBounce(2 * t) : .5 * b.easeOutBounce(2 * t - 1) + .5 }
        }),
        ...
        T = s.clear = function(t) { t.ctx.clearRect(0, 0, t.width, t.height) },
    ...
    e.instances = {}, e.Type = function(t, i, s) { this.options = i, this.chart = s, this.id = u(), e.instances[this.id] = this, i.responsive && this.resize(), this.initialize.call(this, t) }, a(e.Type.prototype, {
        ...
        clear: function() { return T(this.chart), this },
        ...
        destroy: function() { this.clear(), k(this, this.events), delete e.instances[this.id] },
